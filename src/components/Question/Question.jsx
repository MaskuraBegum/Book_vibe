                ...
                <div className="border-2 border-blue-100 rounded-xl p-4 py-12">
                    ...
                    <div className="collapse collapse-arrow bg-base-200">
                        ...
                        <div className="collapse-content">
                            <p>If you come across any book reviews containing inappropriate content or violating our community guidelines, please report them immediately by emailing us. Our team will review the report and take appropriate action.</p>
                        </div>
                    </div>
                    <div className="collapse collapse-arrow bg-base-200">
                    ...
                    <div className="collapse collapse-arrow bg-base-200">
                        ...
                        <div className="collapse-content">
                            <p>If you need assistance or have any questions regarding our book review website, you can contact our customer support team by sending an email to support book@vibe.com. Our team will be happy to assist you with any inquiries or issues you may have.</p>
                        </div>
                    </div>
                </div>
            </div>
